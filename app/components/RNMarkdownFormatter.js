...
import { StyleSheet, Text, Linking, View, Platform } from "react-native";
  ...
  addOnPress = url => {
    if (url === null) {
      ...
      if (!url.includes("http") || !url.includes("www.")) {
        // this.props.renderNewArticle(url)
      } else {
...
const styles = StyleSheet.create({
  ...
  italicText: {
    //fontFamily: "Cursivestandardbold",
    fontFamily: Platform.OS === "ios" ? "Grand Hotel" : "GrandHotel",
    fontSize: 20,
    color: "#000"
  }
});
